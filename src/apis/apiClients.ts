...
const getProductRequest = (payload: Record<string, any>) =>
  ApiClient.get(
...
const getCartRequest = (payload: Record<string, any>) =>
  ApiClient.get(`/cart?id=${payload.id}`, payload);
const deleteCartRequest = (payload: Record<string, any>) =>
  ApiClient.delete(`cart?id=${payload.id}`, payload);
const getCartProductRequest = (payload: Record<string, any>) =>
  ApiClient.post(`/productCart`, payload);

const getImgMediaRequest = (payload: Record<string, any>) =>
  ApiClient.get(
    `/imageMedia?keySearch=${payload.keySearch || ''}&&limit=${
      constanst.LIMIT
