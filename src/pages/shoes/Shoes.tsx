  ...
  return (
    <div className="shoes">
      <div className="shoes-wapper">
        ...
        <span className="shoes-about">
          Buy and Sell Shoes on StockX. Every item is StockX Verified.
        </span>
      </div>
          ...
          <div className="product-shoes">
            <div className="shoe">
              <div className="shoe-img">
                <img
                  src="https://images.stockx.com/images/Air-Jordan-1-Retro-High-85-Black-White-2023-Product.jpg?fit=fill&bg=FFFFFF&w=140&h=75&fm=avif&auto=compress&dpr=1&trim=color&updated_at=1675762190&q=57"
                  alt=""
                />
              </div>
